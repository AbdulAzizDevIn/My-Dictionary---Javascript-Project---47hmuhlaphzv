...
button.addEventListener("click", () => {
  ...
  if (inputWord == "") {
    ...
    card.innerHTML = "<img src='img/loding.gif'>";
  ...
  if (historybtn.innerText == "HISTORY") {
    ...
    if (localStorage.length == 0) {
      historyPage.innerHTML =
        "<div class = 'empty'><img src='https://cdn-icons-png.flaticon.com/512/1380/1380641.png' alt='image'><span>No Search Found</span></div>";
    }
